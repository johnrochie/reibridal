    ...
    <>
      ...
      <section className="py-16 px-6 lg:px-12 bg-charcoal-deep">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-12">
            <h2 className="font-serif text-2xl text-ivory mb-4">What Are Cookies?</h2>
            <p className="font-sans font-light text-ivory/60 leading-relaxed text-sm">
              ...
              <strong className="font-normal text-ivory">{siteConfig.url}</strong>.
            </p>
          </div>

          <div className="mb-12">
            <h2 className="font-serif text-2xl text-ivory mb-6">Cookies We Use</h2>
            <div className="space-y-6">
              {cookieTypes.map((type) => (
                <div key={type.name} className="border border-ivory/10 p-6">
                  <div className="flex items-start justify-between mb-3">
                    <h3 className="font-serif text-xl text-ivory">{type.name}</h3>
                    <span className={`text-[10px] tracking-widest uppercase font-light px-3 py-1 ${
                      type.required
                        ? 'bg-charcoal text-ivory'
                        : 'bg-charcoal-light text-ivory/50'
                    }`}>
                      {type.required ? 'Always Active' : 'Optional'}
                    </span>
                  </div>
                  <p className="font-sans font-light text-ivory/60 text-sm leading-relaxed mb-3">
                    {type.description}
                  </p>
          ...
          <div className="mb-12">
            <h2 className="font-serif text-2xl text-ivory mb-4">Managing Your Cookies</h2>
            <p className="font-sans font-light text-ivory/60 leading-relaxed text-sm mb-4">
          ...
          <div className="mb-12">
            <h2 className="font-serif text-2xl text-ivory mb-4">Third-Party Cookies</h2>
            <p className="font-sans font-light text-ivory/60 leading-relaxed text-sm">
